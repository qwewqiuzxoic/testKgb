...
function QuestionBox({title, subTitle, question, option, updateData, qIndex,page,pageIndex,check, optionValue,disable}) {
  ...
  return (
    ...
    <>
      ...
      <Wrapper>
        ...
        <Option option={option} updateData={upDate} qIndex={qIndex} check={check} optionValue={optionValue}
        disable={disable}/>
      </Wrapper>:
      null
      }
